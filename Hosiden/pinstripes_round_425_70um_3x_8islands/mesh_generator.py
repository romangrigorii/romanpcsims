...
gen_rx_f = geompy.MakeFaceWires([geompy.MakeEllipse(None, None, i_d*3.4, i_d*1.8)], 1)
...
gen_Rx_trunkdeletion_f = geompy.MakeFaceWires([geompy.MakeEllipse(None, None, i_d*3.4 + delet, i_d*1.8 + delet)], 1)
...
# face2_names_TxIx = [];
face2_indexes_TxIx = [7,8,9,10, 22,23,24,25];
# face2_names_Tx = [];
face2_indexes_Tx = [0,1,2,3,4,5, 12,14,15,17,18,20, 27,28,29,30,31,32];
# face2_names_Rx = [];
face2_indexes_Rx = [6, 16, 26];
