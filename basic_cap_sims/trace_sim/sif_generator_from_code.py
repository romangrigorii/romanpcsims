...
End
    ...
    fw.write("  Target Boundaries(2) = 6 8\n")
    ...
    for i in range(8):
        ...
        fw.write("Boundary Condition " + str(i+3) + "\n")
        fw.write("  Target Boundaries(1) = " + str(i+9) + "\n")
        fw.write("  Name = face" + str(i) + "\n")
        fw.write("  Capacitance Body = " + str(i+1) + "\n")
        fw.write("End\n\n")
