...
# gen_rx_c = geompy.MakeFaceHW(Rx_r*2,Rx_r*3, 1)
...
Tx0_2 = geompy.MakeTranslation(gen_tx_1,step/2, step*5/2, 0)
...
Tx2_0 = geompy.MakeTranslation(gen_tx_1,step*5/2, step/2, 0)
...
face2_names_Tx = [];
face2_indexes_Tx = [0,1,2,3,4,5,8,10,11,13,14,16,19,20,21,22,23,24];
face2_names_Rx = [];
face2_indexes_Rx = [6,12,18];
