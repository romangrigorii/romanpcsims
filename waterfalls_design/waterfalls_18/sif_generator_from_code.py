...
""")
    ...
    for h in range(hor*3):
        bounds = ""
        for i in range(hxc[h]*hor):
            bounds += " " + str(bound)
            bound += 1

        fw.write("Boundary Condition " + str(bc) + "\n")
        fw.write("  Target Boundaries(" + str(hxc[h]*ver) + ") = " + bounds + "\n")
    ...
    for h in range(hor*3):
        bounds = ""
        for i in range(txc[h]*ver):
            bounds += " " + str(bound)
            bound += 1

        fw.write("Boundary Condition " + str(bc) + "\n")
        fw.write("  Target Boundaries(" + str(ver*txc[h]) + ") =" + bounds + "\n")
    ...
    fw.write("Boundary Condition " + str(bc) + "\n")
    fw.write("  Target Boundaries(2) = " + str(bound) + " " + str(bound_r) + " \n")
    fw.write("  Name = \"Rx" + str(rn) + "\"\n")
    fw.write("  Capacitance Body = " + str(cb) + "\n")
    fw.write("End\n\n")
    ...
    fw.write("Boundary Condition " + str(bc) + "\n")
    fw.write("  Target Boundaries(44) =" + bounds + "\n")
    fw.write("  Name = RxIx0\n")
    fw.write("  Capacitance Body = " + str(cb) + "\n")
    fw.write("End\n\n")
