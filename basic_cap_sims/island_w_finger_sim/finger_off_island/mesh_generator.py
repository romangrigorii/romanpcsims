...
box_air_top = geompy.MakeTranslation(box_air0,0,0,d_glass)
...
list_of_bodies = Tlist + Blist + Ilist + Tlist + [box_air_bot, box_air_top, box_glass]

partition = geompy.MakePartition(list_of_bodies, [], [], [], geompy.ShapeType["SOLID"], 0, [], 0)
[air_bot, glass, air_top] = geompy.ExtractShapes(partition, geompy.ShapeType["SOLID"], True)
...
airt_vertex = geompy.MakeVertex(0, 0, d_glass+d_air);
...
geompy.UnionList(face_group,T_plane + B_plane + airb_plane + airt_plane)
...
face_names = ['left_C','airb','GND','island','airt','right_C']
face_indexes = [0,2,3,4,5,7]
